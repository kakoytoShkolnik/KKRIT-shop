...
const SizeTable = () => {
    ...
    const isInFavorites = (size: string) => currentFavoriteItems.find((item) => item.size === size)
    ...
    const headdressSizes = [
        ...
        },
        {
          ...
          isInFavorites: isInFavorites('xl'),
        },
        {
          id: 5,
          ...
          isInFavorites: isInFavorites('xxl'),
        },
    ]
