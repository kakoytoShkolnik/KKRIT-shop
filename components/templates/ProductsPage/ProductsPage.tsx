                ...
                setCatalogCategoryOptions({
                    clothCategoryOptions: [
                        ...
                        },
                        {
                            ...
                            filterHandler: () => handleApplyFiltersWithCategory('long-sleeves'),
                        },
                        {
                            id: 3,
                    ...
                    souvenirsCategoryOptions: [
                        {
                            ...
                            filterHandler: () => handleApplyFiltersWithCategory('business-souvenirs'),
                        },
                        {
                            id: 2,
                            title: translations[lang].comparison['promotional-souvenirs'],
                            filterHandler: () => handleApplyFiltersWithCategory('promotional-souvenirs'),
                        },
                    ],
                })
                break
