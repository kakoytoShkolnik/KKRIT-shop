...
export interface IGetPickUpPointByCityFx {
  city: string
  lang: string
}

export interface IPickUpPointAddressData {
...
export interface IPickupAddressItemProps {
  addressItem: IPickUpPointAddressData
  handleSelectAddress: (arg0: IAddressBBox, arg1: IAddressPosition) => void
  handleChosenAddressData: (arg0: Partial<IPickUpPointAddressData>) => void
}
